...
import BomberMen.BomberGame.GameEntities.Player.PlayerFactory.PlayerFactory;
import BomberMen.BomberGame.GameEntities.Player.PlayerStartPosition;
import BomberMen.BomberGame.GameEntities.Tile.*;
import BomberMen.BomberGame.GameEntities.Tile.TileFactory.TileFactory;
...
public final class BomberLabyrinth extends JPanel implements BomberGameConstants {
	...
	private Timer timer = new Timer(16, event -> repaint());
